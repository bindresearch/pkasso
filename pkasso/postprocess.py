...
class Scan:
    ...
    def export_scan(self, file: Path, fig_scan: Figure_plt, fig_mols: Any, size_y: float = 150.0) -> None:
    ...
    @staticmethod
    def compose_image(svg_scan: SVG, svg_mols: SVG, file: Path, N_relevant_states: int, size_y: float = 150.0) -> None:
