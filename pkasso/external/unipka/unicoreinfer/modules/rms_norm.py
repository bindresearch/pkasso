...
try:
    import unicoreinfer_fused_rmsnorm
    import unicoreinfer_fused_rmsnorm_backward_gamma
...
class FusedRMSNormFastFunction(torch.autograd.Function):
    ...
    def forward(ctx, input, weight, normalized_shape, eps):
        ...
        output, invvar = unicoreinfer_fused_rmsnorm.forward(
    ...
    def backward(ctx, grad_output):
        ...
        grad_input = unicoreinfer_fused_rmsnorm.backward(
        ...
        grad_weight = unicoreinfer_fused_rmsnorm_backward_gamma.backward(
            grad_output.contiguous(),
            invvar,
            input_,
            ctx.normalized_shape,
