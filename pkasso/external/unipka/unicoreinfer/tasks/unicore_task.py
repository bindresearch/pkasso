...
class UnicoreTask(object):
    ...
    def get_batch_iterator(
        ...
        Args:
            dataset (~unicoreinfer.data.UnicoreDataset): dataset to batch
            ...
            disable_iterator_cache (bool, optional): don't cache the
                ...
                (default: False).
        Returns:
            ~unicoreinfer.iterators.EpochBatchIterator: a batched iterator over the
                given dataset split
        """
    ...
    def build_model(self, args: Namespace):
        """
        Build the :class:`~unicoreinfer.models.BaseUnicoreModel` instance for this
        task.
    ...
    def build_loss(self, args: Namespace):
        """
        Build the :class:`~unicoreinfer.losses.UnicoreLoss` instance for
        this task.
    ...
    def train_step(
        ...
        Args:
            sample (dict): the mini-batch. The format is defined by the
                :class:`~unicoreinfer.data.UnicoreDataset`.
            model (~unicoreinfer.models.BaseUnicoreModel): the model
            loss (~unicoreinfer.losses.UnicoreLoss): the loss
            optimizer (~unicoreinfer.optim.UnicoreOptimizer): the optimizer
