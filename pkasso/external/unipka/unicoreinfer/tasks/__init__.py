...
def register_task(name):
    """
    New tasks can be added to unicoreinfer with the
    :func:`~unicoreinfer.tasks.register_task` function decorator.
    ...
    .. note::
        ...
        All Tasks must implement the :class:`~unicoreinfer.tasks.UnicoreTask`
        interface.
...
for file in os.listdir(tasks_dir):
    ...
    if (
        ...
        module = importlib.import_module("unicoreinfer.tasks." + task_name)
