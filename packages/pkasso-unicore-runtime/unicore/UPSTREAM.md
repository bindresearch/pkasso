...
The `unicore` Python package was copied from the upstream commit and reduced
for pKasso Uni-pKa inference:

- removed `unicore_cli`;
- removed the trainer, optimizers, learning-rate schedulers, EMA, and NaN
  detector;
- omitted all C++ and CUDA extension sources;
- removed eager optimizer imports from `unicore/__init__.py`;
