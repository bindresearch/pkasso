...
path_out_autoprot = 'notauto_autoprot_output_asdf'
...
# f_input = '/home/sobuelow/projects/asdf_ligands/Cmp_trial_asdf/asyn_asdf_mod.smi' # '../asyn_ligands_asdf.smi' # 'test.smi' # 'test.smi' # 'asdf.smi' # 
# f_input = '/home/sobuelow/projects/asdf_ligands/asyn_ligands_asdf.smi'
